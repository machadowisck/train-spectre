...
class SPECTRE(nn.Module):
    ...
    def _create_model(self, model_cfg):
        ...
        self.E_expression = PerceptualEncoder(model_cfg.n_exp, model_cfg.backbone).to(self.device)
        ...
        if os.path.exists(model_path):
            ...
            self.E_flame.load_state_dict(processed_checkpoint['E_flame'],strict=False)#strict=True
            try:
                m,u = self.E_expression.load_state_dict(processed_checkpoint['E_expression'],strict=False)#strict=True
